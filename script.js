...
const TRANSLATIONS = {
  en: {
    ...
    f1_p:  'Select text in any app — Xcode, Safari, Slack, PDFs — press <span class="kbd-group"><kbd>⌥</kbd><kbd>⌘</kbd><kbd>T</kbd></span> and you\'re done. Works everywhere, system-wide.',
    f2_h3: 'Auto-flip',
    ...
    lang_title: '12 languages.<br>More coming.',
    lang_en: 'English',
    lang_es: 'Spanish',
    lang_ca: 'Catalan',
    lang_fr: 'French',
  ...
  es: {
    ...
    f1_p:  'Selecciona texto en cualquier app — Xcode, Safari, Slack, PDFs — pulsa <span class="kbd-group"><kbd>⌥</kbd><kbd>⌘</kbd><kbd>T</kbd></span> y listo. Funciona en todo el sistema.',
    f2_h3: 'Auto-flip',
    ...
    lang_label: 'Idiomas',
    lang_title: '12 idiomas.<br>Más próximamente.',
    lang_en: 'Inglés',
    lang_es: 'Español',
    lang_ca: 'Catalán',
    lang_fr: 'Francés',
